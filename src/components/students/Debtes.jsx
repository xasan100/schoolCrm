...
//   const { data: debtsData, error, isLoading } = useGetStudenDebtsQuery({ id: ID }, { skip });
...
//                     </div>
//                     <div className="text-sm font-semibold leading-6 text-gray-900">
//                       {val.paid ? <p className="text-sm font-semibold leading-6 text-green-500">Tulov Qilingan</p> : <p
...
//                     <div>
//                       <button
//                         onClick={() => setInput({ input, open: true })}
//                         type="button"
